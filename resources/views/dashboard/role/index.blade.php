...
@include('dashboard.layouts.alerts')
							...
							<div class="d-flex flex-column flex-column-fluid">
								...
								@include('dashboard.layouts.toolbar', ['title'=>__('trans.roles'), 'breadcrumbs'=>[__('trans.home')=>'dashboard', __('trans.roles')=>'roles']])
									
									@include('dashboard.card.open')
									
										@include('dashboard.card.header', ['title'=>'<input type="text" id="search" data-kt-customer-table-filter="search" class="form-control form-control-solid" placeholder="'.__('trans.search').'" >', 'toolbar'=>'roles'])
