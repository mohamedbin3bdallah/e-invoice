								...
								<div class="app-navbar-item" id="kt_header_user_menu_toggle">
									...
									<div class="btn btn-flex align-items-center bg-hover-white bg-hover-opacity-10 py-2 px-2 px-md-3" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
										...
										<div class="d-none d-md-flex flex-column align-items-end justify-content-center me-2 me-md-4">
											<span class="text-white fs-8 fw-bold lh-1 mb-1">{{ Auth::user()->fname.' '.Auth::user()->lname }}</span>
											<span class="text-white fs-8 opacity-75 fw-semibold lh-1">{{ Auth::user()->group->name }}</span>
										</div>
										<!--end::Name-->
										<!--begin::Symbol-->
										<div class="symbol symbol-30px symbol-md-40px">
											<img src="{{ url('users/images/thumbnails/'.Auth::user()->image_thumbnail) }}" alt="image" />
										</div>
										<!--end::Symbol-->
									</div>
									<!--end::User info-->
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="symbol symbol-50px me-5">
													<img alt="Logo" src="{{ url('users/images/thumbnails/'.Auth::user()->image_thumbnail) }}" />
												</div>
												<!--end::Avatar-->
												<!--begin::Username-->
										...
										<div class="menu-item px-5">
											<form action="{{ route('logout') }}" method="POST">
												@csrf
												<button type="submit" class="btn btn-link px-5">{{ __('trans.logout') }}</button>
											</form>
										</div>
										<!--end::Menu item-->
									</div>
