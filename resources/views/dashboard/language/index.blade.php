<x-app-layout>
							...
							<div class="d-flex flex-column flex-column-fluid">
								...
								@include('dashboard.layouts.toolbar', ['title'=>'Languages', 'breadcrumbs'=>['home'=>'dashboard', 'languages'=>'languages']])
									
									@include('dashboard.card.open')
									
										@include('dashboard.card.header', ['title'=>'<input type="text" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Customers" >', 'toolbar'=>'languages'])
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">{{ _('Name') }}</th>
														<th class="min-w-125px">{{ _('Local') }}</th>
														<th class="min-w-125px">{{ _('Dir') }}</th>
														<th class="min-w-125px">{{ _('Default') }}</th>
												...
												<tbody class="fw-semibold text-gray-600">
													...
													<tr>
														...
														<!--begin::Name=-->
														<td>{{ $resource->name }}</td>
														<td>{{ $resource->local }}</td>
														<td data-filter="mastercard">@if($resource->dir) {{ _('RTL') }} @else {{ _('LTR') }} @endif</td>
														<td>@if($resource->def) {{ _('Yes') }} @else {{ _('No') }} @endif</td>
														...
														<td class="text-end">
															...
															<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
																...
																<div class="menu-item px-3">
																	<a href="{{ route('language-file-show', ['local'=>$resource->local]) }}" class="menu-link px-3">View File</a>
																</div>
																<!--end::Menu item-->
																<!--begin::Menu item-->
																<div class="menu-item px-3">
								...
								<div class="modal fade" id="kt_modal_add_customer" tabindex="-1" aria-hidden="true">
										...
										<div class="modal-dialog modal-dialog-centered mw-650px">
											...
											<div class="modal-content">
												<!--begin::Form-->
												<form class="form" action="#" id="kt_modal_add_customer_form" data-kt-redirect="../../demo22/dist/apps/customers/list.html">
													<!--begin::Modal header-->
