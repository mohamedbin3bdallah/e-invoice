...
@include('dashboard.layouts.alerts')
							...
							<div class="d-flex flex-column flex-column-fluid">
								...
								@include('dashboard.layouts.toolbar', ['title'=>__('trans.users'), 'breadcrumbs'=>[__('trans.home')=>'dashboard', __('trans.users')=>'users']])
									
									@include('dashboard.card.open')
									
										@include('dashboard.card.header', ['title'=>'<input type="text" id="search" data-kt-customer-table-filter="search" class="form-control form-control-solid" placeholder="'.__('trans.search').'" >', 'toolbar'=>'users'])
											...
											<table class="table align-middle table-row-dashed fs-6 gy-5" id="dataTable">
												...
												<thead>
													...
													<tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-125px">{{ __('trans.role') }}</th>
														<th class="min-w-125px">{{ __('trans.company') }}</th>
														<th class="min-w-125px">{{ __('trans.branch') }}</th>
														<th class="min-w-125px">{{ __('trans.email') }}</th>
														<th class="min-w-125px">{{ __('trans.gender') }}</th>
